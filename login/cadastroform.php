    ...
    <div class="container">
        <form action="functions/cadastrar.php" method="POST">
            ...
            <div class="form-row"> 
                  ...
                  <input class="form-control" type="text" maxlength="50" placeholder="Email" name="email_user" id="email_user" required>
            </div>
            ...
            <div class="form-row"> 
                  ...
                  <input class="form-control" type="text" maxlength="11" placeholder="CPF" name="cpf" id="cpf" required>
            </div>

            <div class="form-row"> 
                  <input class="btn btn-light col-md-3" type="submit" value="Enviar">
                  <a class="redirect" href="loginform.php">Fazer login</a>
            </div>
